    ...
    <div class="row">
           <div class="col-xs-4">
            <div class="card" style="width: 40rem;">
              <img class="card-img-top" src="{{asset('images/produtos/sofa/03.jpg')}}" alt="Card image cap">
          ...
          <div class="col-xs-4 col-md-offset-1">
                <div class="card" style="width: 40rem;">
                <img class="card-img-top" src="{{asset('images/produtos/sofa/01.jpg')}}" alt="Card image cap">
                <div class="card-block">
